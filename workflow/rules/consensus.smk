...
rule consensus_individual:
    input:
        expand("{bam_dir}/{individual}{extension}.bam", bam_dir = config["bam_dir"], individual = get_individuals().keys(), extension = config["final_bam_extension"]),
        expand("{bam_dir}/{individual}{extension}.bam.bai", bam_dir = config["bam_dir"], individual = get_individuals().keys(), extension = config["final_bam_extension"])
    output:
